package com.scientific.calculator.scientificcalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private Button btnsin, btncos, btntan, btnadd, btnsub, btnmul, btndiv, btnSqrt, btnatan, btnSav, btnRec, btnClr, btnc;
    private EditText etnum, etres, etnum2;
    private static double memoryValue, inputvalue;
    private TextView viewm, viewm2;
    ...
    private void init() {
        ...
        viewm = (TextView) findViewById(R.id.viewm);
        viewm.setVisibility(View.INVISIBLE);
        viewm2 = (TextView) findViewById(R.id.viewm2);
        viewm2.setVisibility(View.INVISIBLE);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnmr:
                ...
                break;
            case R.id.btnms:
                viewm2.setVisibility(View.VISIBLE);
                ...
                if (Double.isNaN(inputvalue)) {
                    ...
                    viewm.setText(String.valueOf(memoryValue));
                }
                break;
